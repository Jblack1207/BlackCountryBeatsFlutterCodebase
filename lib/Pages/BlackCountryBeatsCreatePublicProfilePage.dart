...
class _BlackCountryBeatsCreatePublicProfilePageState
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      await _firestore.collection('publicProfiles').add({
        'userId': user.uid,
  ...
  Widget build(BuildContext context) {
    final topInset = MediaQuery.of(context).padding.top - 63;
                            ...
                            Center(
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    backgroundColor: const Color(0xFF2A2823),
